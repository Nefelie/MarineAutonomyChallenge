...
#test
# vehicle_posision  = np.array([5050.710000, 00044.750000])
# previous_waypoint = np.array([5050.700000, 00044.750000])
# current_waypoint  = np.array([5050.720000, 00044.750000])
# print(LOS_latlon(vehicle_posision,previous_waypoint,current_waypoint),'correct_heading:',0)

# vehicle_posision  = np.array([5050.720000, 00044.750000])
# previous_waypoint = np.array([5050.700000, 00044.750000])
# current_waypoint  = np.array([5050.710000, 00044.750000])
# print(LOS_latlon(vehicle_posision,previous_waypoint,current_waypoint),'correct_heading:',180)

# vehicle_posision  = np.array([5050.710000, 00044.850000])
# previous_waypoint = np.array([5050.700000, 00044.750000])
# current_waypoint  = np.array([5050.720000, 00044.750000])
# print(LOS_latlon(vehicle_posision,previous_waypoint,current_waypoint),'correct_heading:',270)

# vehicle_posision  = np.array([5050.710000, 00044.650000])
# previous_waypoint = np.array([5050.700000, 00044.750000])
# current_waypoint  = np.array([5050.720000, 00044.750000])
# print(LOS_latlon(vehicle_posision,previous_waypoint,current_waypoint),'correct_heading:',90)